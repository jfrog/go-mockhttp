...
// Request creates a new request matcher. By default it matches everything. Use configuration methods to narrow down what matches
...
// Method matches requests with the given HTTP method (exact match)
...
// Path matches requests with the given path (exact match)
...
// PathMatches matches requests with path that matches the given regular expression
...
// GET request with the given path.
//   GET("/foo")
...
// POST request with the given path.
//   POST("/foo")
// Which is a shortcut for:
...
// PUT request with the given path.
//   PUT("/foo")
// Which is a shortcut for:
//   Method("PUT").Path("/foo")
...
// DELETE request with the given path.
//   DELETE("/foo")
// Which is a shortcut for:
...
// Header matches requests with the given header key-value pair (exact match)
...
// HeaderMatches matches requests with the given header key-value pair, the value is evaluated using the given regular expression
...
// NoHeader matches requests only if it does not have a header with the given key
...
// Query matches requests with the given query key-value pair (exact match)
...
// QueryMatches matches requests with the given query key-value pair, the value is evaluated using the given regular expression
...
// NoQuery matches requests only if it does not have a query with the given key
